...
public class GestorLite {
    ...
    public static Client creaClientDemo() {
        ...
        client.getLloguers().add(new Lloguer(new Vehicle("Fiat", "Uno", 3), 1));
        client.getLloguers().add(new Lloguer(new Vehicle("Tata", "Vista", 3), 1));
        client.getLloguers().add(new Lloguer(new Vehicle("Seat", "600", 3), 1));
        return client;
    }
